...
bool DirectLightingGpu::init(std::string *error)
{
    ...
    if(camera_location_<0||light_count_location_<0||primitive_count_location_<0
            ||static_split_light_index_location_<0)
    {
